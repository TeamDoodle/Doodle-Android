...
class AppreciateDayViewHolder(itemView:View?):RecyclerView.ViewHolder(itemView) {
    ...
    var commentCount:TextView=itemView!!.findViewById(R.id.day_comment_count)
    var likeCount:TextView=itemView!!.findViewById(R.id.day_like_count)
    var scrapCount:TextView=itemView!!.findViewById(R.id.day_scrap_count)
}